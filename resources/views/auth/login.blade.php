...
@section('content')
            ...
            <div class="brand-content">
                ...
                <div class="illustration">
                    <svg width="200" height="200" viewBox="0 0 500 500">
                        ...
                        <path d="M355 170C355 226.885 309.183 273 250 273C190.817 273 145 226.885 145 170C145 113.115 190.817 67 250 67C309.183 67 355 113.115 355 170Z" fill="white" fill-opacity="0.25"/>
                        <path d="M145 350C145 297.533 191.533 255 250 255C308.467 255 355 297.533 355 350V400H145V350Z" fill="white" fill-opacity="0.25"/>
                    </svg>
                </div>
    ...
    <style>
        ...
        /* Make the image transparent - elegant approach */
        .transparent-image {
            opacity: 0.9;
            /* Slightly more visible */
            filter: brightness(1.2) contrast(0.9);
            /* Enhances visibility while maintaining transparency */
            mix-blend-mode: screen;
            /* Better blend with blue background */
            max-width: 80%;
            /* Slightly smaller for better aesthetic */
            height: auto;
        ...
        .illustration:hover .transparent-image {
            opacity: 1;
