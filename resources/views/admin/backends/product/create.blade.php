...
@section('contents')
    <section class="content-header px-0">
        <div class="d-flex flex-row justify-content-between">
            <a href="{{ route('product.index') }}" class="d-flex flex-row cursor-pointer"
                style="text-decoration: none; color: black;">
                <img src="{{ asset('images/chevron-left.png') }}" style="width: 25px; height: 35px;" class="mr-1">
                <h3 class="title">{{ __('Create Product') }}</h3>
            </a>
        </div>
    </section>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" id="name" name="name" value="{{ old('name') }}"
                                    class="form-control" required placeholder="{{ __('Enter product name') }}">
                            </div>
                            <div class="form-group col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="file" name="image" id="image" class="dropify" data-show-loader="false"
